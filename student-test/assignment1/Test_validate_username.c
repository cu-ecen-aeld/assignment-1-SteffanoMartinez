...
void test_validate_my_username()
{
    ...
    const char *written_username = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING_MESSAGE(hardcoded_user,written_username,"Both sources match GH Usernames.");

    free((void *)written_username);
}
